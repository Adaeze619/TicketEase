...
namespace TicketEase.Application.ServicesImplementation
{
    public class EmailServices : IEmailServices
    {
        ...
        public async Task SendHtmlEmailAsync(MailRequest mailRequest)
        {
            ...
            if (System.IO.File.Exists("EmailAttachment/freedom.jpeg") && System.IO.File.Exists("EmailAttachment/lorem.jpeg"))
            {
                using (var ms1 = new MemoryStream())
                using (var file1 = new FileStream("EmailAttachment/freedom.jpeg", FileMode.Open, FileAccess.Read))
                {
                    file1.CopyTo(ms1);
                ...
                using (var file2 = new FileStream("EmailAttachment/lorem.jpeg", FileMode.Open, FileAccess.Read))
                {
                    file2.CopyTo(ms2);
